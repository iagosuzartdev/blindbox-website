      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#servicos" className="text-gray-300 hover:text-white transition-colors">Manutenção de Blindex</a></li>
              <li><a href="#servicos" className="text-gray-300 hover:text-white transition-colors">Troca de Roldanas</a></li>
              <li><a href="#servicos" className="text-gray-300 hover:text-white transition-colors">Ajuste de Portas</a></li>
              <li><a href="#servicos" className="text-gray-300 hover:text-white transition-colors">Instalação de Fechaduras</a></li>
              <li><a href="#servicos" className="text-gray-300 hover:text-white transition-colors">Troca de Molas</a></li>
            </ul>
          </div>
